...
if ($myQuery != False && $myQuery->fetch_assoc()){
    $mysqli->query("UPDATE Dating_Website.Liked SET matched = 1 WHERE person1='$likee' AND person2='$liker'");
}
else{
    $mysqli->query("INSERT INTO Dating_Website.Liked (person1, person2) VALUES ('$liker', '$likee')");
}
